...
Google Forms
W3 Schools
HTML & CSS: Design and build websites. by Duckett, J (2011)

AI was used in troubleshooting/debugging and to generate ideas for color palettes and layout. It was never used to generate pure code.
